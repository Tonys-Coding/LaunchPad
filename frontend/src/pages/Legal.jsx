...
const privacySections = [
  ["Information LaunchPad stores", "LaunchPad stores your account name and email, preferences, job applications, notes, calendar events, application goals, Career Profile records, resume contact details, structured master resumes, tailored resume versions, and files you choose to attach or import. This information is private to your account."],
